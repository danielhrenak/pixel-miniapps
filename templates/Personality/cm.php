...
<body class="bg-[#fafafa] font-['Outfit',sans-serif] p-4 md:p-12 print:p-0">
    ...
    <script>
        ...
        const teamMembers = [
            { name: "Veronika Balusikova", personality: "ENFJ", role: "Protagonist", group: "Diplomat", nick: "Verča", photo: "https://hr.pixelfederation.com/photo/vbalusikova-hover.jpg" },
            { name: "Andrea Matusova", personality: "INFP", role: "Mediator", group: "Diplomat", nick: "Aďa", photo: "https://hr.pixelfederation.com/photo/amatusova-hover.jpg" },
            { name: "Martina Melichova", personality: "ISTJ", role: "Logistician", group: "Sentinel", nick: "Maťa", photo: "https://hr.pixelfederation.com/photo/mmelichova-hover.jpg" },
            { name: "Alzbeta Vankova", personality: "ENFJ", role: "Protagonist", group: "Diplomat", nick: "Alz", photo: "https://hr.pixelfederation.com/photo/avankova-hover.jpg" },
            { name: "Andrej Zemko", personality: "ENTP", role: "Debater", group: "Analyst", nick: "Andy", photo: "https://hr.pixelfederation.com/photo/azemko-hover.jpg" },
            { name: "Alexantra Palkova", personality: "INFJ", role: "Advocate", group: "Diplomat", nick: "Saš", photo: "https://hr.pixelfederation.com/photo/apalkova.jpg" },
            { name: "Tomas Havko", personality: "INFP", role: "Mediator", group: "Diplomat", nick: "Tomo", photo: "https://hr.pixelfederation.com/photo/thavko.jpg" }
        ];
        ...
        const personalityDefinitions = {
            ...
            "INFP": { title: "Mediator", traits: ["Idealistic", "Empathetic", "Creative", "Passionate"], keyTraits: ["Introverted", "Intuitive", "Feeling", "Prospecting"], description: "Poetic, kind and altruistic people, always eager to help a good cause." },
            "ENTP": { title: "Debater", traits: ["Innovative", "Quick-witted", "Knowledgeable", "Curious"], keyTraits: ["Extraverted", "Intuitive", "Thinking", "Prospecting"], description: "Smart and curious thinkers who cannot resist an intellectual challenge." },
            "INFJ": { title: "Advocate", traits: ["Quiet", "Inspiring", "Altruistic", "Idealistic"], keyTraits: ["Introverted", "Intuitive", "Feeling", "Judging"], description: "Quiet and mystical, yet very inspiring and tireless idealists." }
        };
